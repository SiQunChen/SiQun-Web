...
export const translations: TranslationData = {
  portfolio: {
    ...
    projects: [
      {
        title: 'リアルタイム物体検出システム',
        description: 'YOLOv5を使用し、ビデオストリーム内の複数の物体をリアルタイムで高精度に識別できる高性能な物体検出システムを開発しました。',
      ...
      {
        title: '個人ポートフォリオサイト',
        description: 'React、TypeScript、Tailwind CSSで構築された、完全レスポンシブな個人ウェブサイト。私のプロジェクトとスキルを紹介するために、パフォーマンスとデザイン性を重視して設計しました。',
        tags: ['React', 'TypeScript', 'Tailwind CSS'],
        imageUrl: 'https://picsum.photos/seed/project2/400/300',
        githubUrl: '#',
      },
      {
        title: '医療画像のための画像セグメンテーション',
        description: 'U-Netベースのモデルを実装し、医療画像のセマンティックセグメンテーションを行い、MRIスキャンでの腫瘍検出において高いDiceスコアを達成しました。',
        tags: ['Python', 'TensorFlow', 'U-Net', '医療画像'],
        imageUrl: 'https://picsum.photos/seed/project3/400/300',
        githubUrl: '#',
      },
       {
        title: 'EコマースプラットフォームAPI',
        description: 'Node.js、Express、MongoDBを使用し、模擬Eコマースプラットフォーム用のRESTful APIを設計・構築しました。ユーザー認証、商品管理、注文処理機能を備えています。',
