...
export const translations: TranslationData = {
  portfolio: {
    ...
    projects: [
      {
        title: '即時物件偵測系統',
        description: '使用 YOLOv5 開發了一個高效能的物件偵測系統，能夠高精度地即時辨識視訊流中的多個物件。',
      ...
      {
        title: '個人作品集網站',
        description: '一個使用 React、TypeScript 和 Tailwind CSS 打造的全響應式個人網站，用以展示我的專案與技能。設計上兼顧了效能與美學。',
      ...
      {
        title: '醫療影像之影像分割',
        description: '實現了一個基於 U-Net 的模型，用於醫療影像的語意分割，在 MRI 掃描中對腫瘤偵測達到了很高的 Dice 分數。',
        tags: ['Python', 'TensorFlow', 'U-Net', '醫療影像'],
        imageUrl: 'https://picsum.photos/seed/project3/400/300',
        githubUrl: '#',
      },
       {
        title: '電商平台 API',
        description: '使用 Node.js、Express 和 MongoDB 設計並建立了一個模擬電商平台的 RESTful API，功能包含使用者驗證、產品管理及訂單處理。',
